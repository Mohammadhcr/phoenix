        ...
        <>
            <div className={`${menuList} ${menu ? `${menuListActive}` : ""}`}>
                <ul className={menuItems}>
                    ...
                    <Link to="/aboutme" onClick={clickHandler}><li><i className='bx bx-info-circle'></i> About Me</li></Link>
                </ul>
                ...
                <div className={rightSide}>
                    <nav>
                        <ul>
                            ...
                            <li><Link to="/aboutme"><i className='bx bx-info-circle'></i> About Me</Link></li>
                    ...
                    <div className={shopCart}>
                        <Link to="/cart">
                            <i className={`bx bx-cart ${bxCart} ${cartList.length ? `${bxCartActive}` : ""}`}></i>
